...
public class SearchSlideDemo extends Application {
    ...
    public void start(Stage stage) throws Exception {
        ...
        table.focusedProperty().addListener( (paramObservableValue , paramT1 , paramT2) -> {
            if(paramT2){
                // To close
                timelineUp.play();
                searchLbl.setGraphic(downArrow);
    ...
    private void configureSearch(StackPane root) {
        ...
        Label searchTitle = new Label( "Search Employee" );
        searchTitle.setFont( Font.font("Arial", 20) );
